...
public:
	int maxProfit(int k, vector<int>& prices) {
		...
		int* global = new int[k + 1]; //目前最多进行k次交易
		int* local = new int[k + 1]; //目前最多进行K次交易，且最后一次卖出在当天
